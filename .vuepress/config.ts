...
const author = "秋天";
const domain = "https://guide.naturemindz.com";
const tags = ["程序员", "编程", "计算机"];

export default defineConfig({
  title: "前端学习路线",
  description: "贴心的前端编程学习路线，全面的编程知识百科",
  head: [
    // 站点图标
    ...
    [
      "meta",
      {
        name: "keywords",
        content:
          " 前端编程学习路线, 编程知识百科, VUE, 编程导航, 前端, 开发, 编程分享, 项目, IT, 求职, 面经",
      },
    ],
    // // 百度统计
    // [
    ...
    //       hm.src = "https://hm.baidu.com/hm.js?2675818a983a3131404cee835018f01";
